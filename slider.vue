<template>
    <div class="wrapper" ref="wrapper"
         ...
         @mouseenter.stop="wrapperEnter"
         @mousemove.stop="wrapperEnter"
         @mouseleave.stop="_playTabs(currentIndex)">
        <div class="slide-wrapper" ref="slide">
            <slot></slot>
        </div>
        <span class="switch" v-if="!touched&&arrowsShow" @click.stop="prev(currentIndex)"><</span>
        <span class="switch" v-if="!touched&&arrowsShow" @click.stop="next(currentIndex)">></span>
        <div class="dots" v-if="dotsShow" ref="dots" @mouseenter.stop="wrapperEnter">
            <div class="dot"
...
<script type="text/ecmascript-6">
    export default {
        ...
        methods: {
            ...
            _setTabsSlide() {
                if (!this.$refs.slide || this.$refs.slide.children.length <= 0) {
                    return
                }
                let children = this.$refs.slide.children;
                let width = 0;
